					...
					<div class="panel-body container-fluid">
						<form action="<?php echo site_url();?>akun/user/tambah" method="post" id="exampleStandardForm" autocomplete="off">
							...
							<div class="form-group form-material">
								...
								<select type="text" class="form-control input-sm" id="user_role" name="user_role" placeholder="Role" required>
									<option value="pejabat">Pejabat</div>
									<option value="sekdis">Sekdis</div>
								</select>
							</div>
					...
					<div class="panel-body container-fluid">
						...
						autocomplete="off">
							...
							<div class="form-group form-material">
								<label class="control-label" for="inputText">Role</label>
								<select type="text" class="form-control input-sm" id="user_role" name="user_role" placeholder="Role" required>
									<option value="<?php echo $user_role; ?>"><?php echo $user_role; ?></div>
									<option value="pejabat">Pejabat</div>
									<option value="sekdis">Sekdis</div>
								</select>
							</div>
